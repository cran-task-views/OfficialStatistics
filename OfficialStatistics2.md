...
This task view is split into two main parts ["Producing Official Statistics"](#prod) and ["Access to Official Statistics"](#access). The first part is targeted at people working at national statistical institutes, national banks, international organizations, etc. who are involved in the production of official statistics. It is loosely aligned to the ["Generic Statistical Business Process Model"](https://statswiki.unece.org/display/GSBPM).
Whereas, the second part's target audience is everyone interested to use official statistics results directly from within R.
The third part is ["Specific Techniques/ Methods"]("specific") which collects methods that are important in official statistics, but do not directly fit into the prodcution. The fourth part ["Misc"]("misc") is a collection of package that are loosely connect to official statistics.


# <a name="prod"></a>Production of Official Statistics
